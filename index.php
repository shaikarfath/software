            ...
            <div class="single-slider slider-height d-flex align-items-center"
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            <!-- form -->
                            <form action="job_listing.php" class="search-box" method="GET">
                                <div class="input-form">
                                    <input type="text" placeholder="Job Title or keyword" name="title">
                                </div>
                                ...
                                <div class="search-form">
                                    <button class="btn head-btn1" type="submit">Find job</button>
                                </div>
                            </form>
                        </div>
                    </div>
